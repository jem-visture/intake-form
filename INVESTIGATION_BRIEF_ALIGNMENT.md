...
| Separate material and labour | Partial | Materials use structured line items with quantity, unit, unit price, and server-calculated totals; labour remains a separate multiline input. Approved rates and AI validation are not implemented. |
